...
def get_allocated_batch_ref(session, orderid, sku):
    [[orderlineid]] = session.execute(
        text("SELECT id FROM order_lines WHERE order_ref=:orderid AND sku=:sku"),
...
# def test_concurrent_updates_to_version_are_not_allowed(postgres_session_factory):  NEED POSTGRES
